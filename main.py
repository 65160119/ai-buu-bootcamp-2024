...
ACCESS_TOKEN = os.getenv("LINE_ACCESS_TOKEN", "/0/E9uHcYNAbTTXvgSohqODzltkpR67UBcvTz5mAJpIrXxIKKMevSTMEIA4Xp0+lzxilC1tdCpN4wQHWNEA9GqdevKcOq2IxzsrGKEe81b+w2U8spZ+TYh6C2lyyNZ5WAz25nWi3J9zyAQS+1BRDtgdB04t89/1O/w1cDnyilFU=")
CHANNEL_SECRET = os.getenv("LINE_CHANNEL_SECRET", "eaeac48879e393dda1fec6211726f83e")

# ข้อมูล Gemini api key
GEMINI_API_KEY = os.getenv("GEMINI_API_KEY", "AIzaSyBHkWGcfJZUIpGz4tVhptkNhnFDjmk4fLg")
...
async def lifespan(app: FastAPI):
    ...
    sample_documents = [
        "นาย พศิน ยุจิเสรี คือ นิสิตของมหาวิทยาลัยบูรพา ปี 3 คณะ วิทยาการสารสนเทศ สาขา วิทยาการสารสนเทศเพื่ออุตสหกรรมดิจิตัล",
        ...
        "งาน BUU-Bootcamp-2024 จัดที่มหาวิทยาลัยบูรพา ในวันที่ 12 ธันวาคม ปีค.ศ.2024 โดยมีการจัดกิจกรรมต่าง ๆ ที่เกี่ยวข้องกับการพัฒนาซอฟต์แวร์ เวลา 9:00 น. - 16:00 น.จำนวน 200คน",
        "มหาวิทยาลัยบูรพา สาขาวิชาAI ปีการศึกษา 2565 มีนักศึกษาจำนวน 100 คน มีอาจารย์ที่ปรึกษา 10 คน",
        "ClickNext ทีม AI ที่มามี พี่ดาว เป็น BA  พี่ออย เป็น BA พี่ปาล์ม เป็น DEV พี่เจ๋ง เป็น DEV พี่ชวน เป็นฝ่าย DATA"
    ]
